...
@section('content')
    <div class="container">
        ...
        {{-- Open Form --}}
        {!! Form::open(['url' => route('usercontroller.register')]) !!}
            <div class="form-group row">
                {{ Form::label('name', '*&nbsp;Name', ['class' => 'col-sm-4 col-form-label text-md-right']) }}
            ...
            <div class="form-group row">
                {{ Form::label('confirmpassword', 'Confirm Password', ['class' => 'col-sm-4 col-form-label text-md-right']) }}
